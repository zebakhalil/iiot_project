...
plt.figure(dpi=300)
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_folder/3threads/3threads_c.csv',
    unpack=True,
    delimiter=',')
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_torm/3threads/3threads_c.csv',
    unpack=True,
    delimiter=',')
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_folder/6threads/6threads_c.csv',
    unpack=True,
    delimiter=',')
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_torm/6threads/6threads_c.csv',
    unpack=True,
    delimiter=',')
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_folder/9threads/9threads_c.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_torm/9threads/9threads_c.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
...
plt.plot([0.0, 60], [0.0, 1500], linewidth=0.0, markersize=0.0)
...
# plt.show()
plt.savefig("/Users/zebakhalil/Desktop/60sec_folder/60sec_TPS.png",dpi=300)