...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_folder/3threads/3threads.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_torm/3threads/3threads.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
         color='green', linestyle='-.', linewidth=2, marker='o',
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_folder/6threads/6threads.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_torm/6threads/6threads.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
         color='orange', linestyle='-.', linewidth=2, marker='o',
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_folder/9threads/9threads.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
...
x, y = np.loadtxt(
    '/Users/zebakhalil/Desktop/60sec_torm/9threads/9threads.csv',
    unpack=True,
    delimiter=',')
plt.plot(x, y,
         color='purple', linestyle='-.', linewidth=2, marker='o',
...
plt.title('Runtime = 60 secs')
# plt.show()
plt.savefig("/Users/zebakhalil/Desktop/60sec_folder/60sec_RTT.png",dpi=300)